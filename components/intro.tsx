 ...
 const{setActiveSection, setTimeOfLastClick} = useActiveSectionContext()
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello I'm Pedro</span>, <br />
        from sunny Lisbon ☀️ living in rainy London <br />
        I'm a <span className="font-bold">Full Stack Developer</span>, and a
        recent graduate from <span className="font-bold">Ironhack</span>,
      </motion.h1>
      <motion.div
      ...
      >
        ...
        <a
          className=" group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-[1.15] hover:scale-110  active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
